...
<img src="Assets/IOEM%20Validation/user_email.jpg" alt="user email">
<p>The users will click on the link and will see the following editable fields:</p>
<img src="Assets/IOEM%20Validation/IOEM%20write-up11.png" alt="item_view"> 
...
<img src="Assets/IOEM%20Validation/IOEM%20write-up2.png" alt="item_view">
...
<img src="Assets/IOEM%20Validation/IOEM%20write-up3.png" alt="top_half_of_primary_flow">
...
<p align= center><img src="Assets/IOEM%20Validation/primary_flow_1.png" alt="top_half_of_flow"></p>
...
<p align= center><img src="Assets/IOEM%20Validation/primary_flow.png" alt="bottom_half_of_flow"></p>
...
<img src="Assets/IOEM%20Validation/ioem%20write-up12.png" alt="see_all">
<p>Then click the cog, List settings, then Permissions for this list:</p>   
<img src="Assets/IOEM%20Validation/ioem%20write-up13.png" alt="list_view"><br>
<img src="Assets/IOEM%20Validation/IOEM%20write-up14.png" alt="sp_group_settings">
...
<img src="Assets/IOEM%20Validation/IOEM%20write-up15.png" alt="navigating_to_group">
<p>Click on New > Add Users:</p>
<img src="Assets/IOEM%20Validation/IOEM%20write-up16.png" alt="adding_users_to_group">
...
<img src="Assets/IOEM%20Validation/IOEM%20write-up17.png"> 
...
<p align= center><img src="Assets/IOEM%20Validation/secondary_flow.png" alt="secondary_flow"></p>
<p>This flow is designed to send an email to the assignee of the bucket name that is submitted via a Form:</p>
<p align= center><img src="Assets/IOEM%20Validation/additional_buckets.png" alt="additional_buckets"></p>
